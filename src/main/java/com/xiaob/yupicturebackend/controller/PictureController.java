...
import com.xiaob.yupicturebackend.model.dto.picture.PictureEditRequest;
import com.xiaob.yupicturebackend.model.dto.picture.PictureQueryRequest;
import com.xiaob.yupicturebackend.model.dto.picture.PictureUpdateRequest;
...
public class PictureController {
    ...
    public BaseResponse<Boolean> deletePicture(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        if (deleteRequest == null || deleteRequest.getId() <= 0 || deleteRequest.getId() <= 1) {
